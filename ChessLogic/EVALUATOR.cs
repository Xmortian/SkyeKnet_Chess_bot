...
namespace ChessLogic
{
    public static class Evaluator
    {
        ...
        public static int Evaluate(board board, Player perspective, List<Move>? legalMoves = null)
        {
            ...
            // Only now instantiate for mobility if needed
            StateOfGame state = new StateOfGame(perspective, board, false);

            int mobilityScore = (legalMoves ?? new StateOfGame(perspective, board, false).AllLegalMovesFor(perspective)).Count() * MobilityScaleFactor;
            score += mobilityScore;
            ...
            return score; // ✅ Ensure the function always returns an int
